...
class AGI
{
    ...
    */
	...
	function get_peer_data($tech,$peer,$field=null)
	{
		$data=$this->evaluate('"'.$tech.' show peer '.$peer.'"');
    ...
    */
    function exec($application, $options)
    {
		...
		msg($p."EXEC $application $options",2);
    ...
    */
    ...
    {
		global $dummyMode;
		if ($dummyMode) return 'dummy_'.$variable;
    ...
    */
    function parse_callerid($callerid=NULL)
    {
        ...
        if (isset($this->request['agi_calleridname'])&&strlen($this->request['agi_calleridname'])) 
			$ret['name'] = $this->request['agi_calleridname'];
    ...
    */
    ...
    {
		/*global $dummyMode;
		if (isset($dummyMode)&&$dummyMode) {
			echo 'AGI command muted by dummy mode: '.$command."\n";
		}*/
